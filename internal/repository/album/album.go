...
func (repo *albumRepository) GetAllAlbum(ctx context.Context, offset string, limit string, filter_artist_id string) ([]entity.Album, error) {
	return repo.postgres.GetAllAlbum(ctx, offset, limit, filter_artist_id)
}
